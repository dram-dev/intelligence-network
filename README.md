...
| `ams_grain` | official · 0.95 | 6 h | USDA AMS Market News (report 3192): the spot basis for corn, soybeans and wheat in twelve Illinois trading districts — one reading per market per weekday publication (~25), each on the county that stands for it, with the cash bid in evidence. Needs a free `USDA_MARS_KEY`; without one the feed stays quiet |
